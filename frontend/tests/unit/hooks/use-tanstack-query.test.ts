...
let useApiQuery: typeof import('@/hooks/use-tanstack-query').useApiQuery;
let useApiMutation: typeof import('@/hooks/use-tanstack-query').useApiMutation;
...
describe('useApiQuery', () => {
    ...
    beforeAll(async () => {
        ...
        const hooks = await import('@/hooks/use-tanstack-query');
