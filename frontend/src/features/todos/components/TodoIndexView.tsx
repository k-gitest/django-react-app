...
type TodoIndexViewProps = {
  onCreateSubmit: (values: TodoFormValues) => Promise<void>;
};

export const TodoIndexView = ({ onCreateSubmit }: TodoIndexViewProps) => {
  return (
    <div className="container mx-auto py-8 px-4 space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <TodoCreateForm onSubmit={onCreateSubmit} />
      </div>
