...
class TodoSerializerTestCase(TestCase):
    ...
    def test_serialize_multiple_todos(self):
        ...
        todo2 = Todo.objects.create(
            user=self.user, todo_title="タスク2", priority=Todo.Priority.HIGH
        )
    ...
    def test_deserialize_valid_data(self):
        """デシリアライズ: 正常なデータの検証"""
        data = {"todo_title": "新しいタスク", "priority": "HIGH", "progress": 75}
    ...
    def test_validate_progress_valid_values(self):
        ...
        for progress in [0, 50, 100]:
            data = {"todo_title": "テスト", "progress": progress}

            serializer = TodoSerializer(data=data)

            self.assertTrue(
                serializer.is_valid(), f"progress={progress} should be valid"
            )
            self.assertEqual(serializer.validated_data["progress"], progress)

    def test_validate_progress_negative(self):
        """バリデーション: 負の進捗率はエラー"""
        data = {"todo_title": "テスト", "progress": -1}
    ...
    def test_validate_progress_over_100(self):
        ...
        data = {"todo_title": "テスト", "progress": 101}
    ...
    def test_validate_progress_not_integer(self):
        ...
        data = {"todo_title": "テスト", "progress": "invalid"}
    ...
    def test_validate_progress_float(self):
        """バリデーション: 浮動小数点数はエラー"""
        data = {"todo_title": "テスト", "progress": 50.5}
    ...
    def test_validate_priority_valid_choices(self):
        ...
        for priority in ["LOW", "MEDIUM", "HIGH"]:
            data = {"todo_title": "テスト", "priority": priority}
    ...
    def test_validate_priority_invalid_choice(self):
        ...
        data = {"todo_title": "テスト", "priority": "INVALID"}
    ...
    def test_update_existing_todo(self):
        """更新: 既存Todoの更新"""
        data = {"todo_title": "更新されたタイトル", "progress": 100}
